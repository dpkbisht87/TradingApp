...
import com.payconiq.tradingapp.config.PropertiesConfig;
...
public class StockException {
    ...
    @Autowired
    public StockException(PropertiesConfig propertiesConfig) {
        StockException.propertiesConfig = propertiesConfig;
    }
